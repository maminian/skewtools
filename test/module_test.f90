! Some code demonstrating the purpose of modules in fortran. 
! Basically, the idea is that the module can store variable 
! definitions, parameters, and possibly subroutines and functions
! which would be commonly used throughout a project.
!
