subroutine read_inputs_mc(param_file,aratio,q,Pe,nGates,x0n,x0width,y0,z0,save_hist,n_bins,save_hist2d,t_warmup,&
                              use_external_ic,ic_file,tstep_type,dt,dtmax,Tfinal,tsteps,other_file,mt_seed)
...
implicit none
     ...
     open(funit,file=param_file)
          ...
          read(funit,*) n_bins     ! Number of bins to use in the short direction for pointwise statistics. 
